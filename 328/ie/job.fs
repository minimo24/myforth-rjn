...
here starts .( rjn-serial)
include ./rjn-serial.fs
here 7 spaces ends
...
\       8 T ldi,  T sty+,       \ 57600 baud, 8 MHz crystal
      16 T ldi,  T sty+,       \ 57600 baud, 16 MHz crystal
   0 T ldi,  T sty+,  
...
\ : cold  entry cli, init-serial init-stacks  ( init-interrupt) go ;
13 spaces here ends
